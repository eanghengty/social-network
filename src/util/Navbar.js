                    ...
                    <div className="collapse navbar-collapse" id="child">
                        <ul className="margin-ul navbar-nav">
                            {auth.isLogin && (<li className="nav-item">
                                <NavLink to="/:userId/allpost" exact className="drop-shadow__a nav-link  text-white"><FontAwesomeIcon icon={faUsers} className="fa-custom fa-2x"></FontAwesomeIcon>    Your post</NavLink>
                            </li>)}
